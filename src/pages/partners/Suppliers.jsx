        ...
        <table className="w-full text-sm">
          <thead className="bg-muted/30 border-b border-border">
            <tr>
              ...
              <th className="text-left px-4 py-2.5 text-xs font-semibold text-muted-foreground">AP Ledger</th>
          ...
          <tbody className="divide-y divide-border">
            {loading ? (
              ...
              <tr><td colSpan={8} className="text-center py-12 text-muted-foreground text-sm">No suppliers found</td></tr>
