            ...
            <div className="border rounded-lg overflow-hidden">
              <table className="table-fluid-grid text-sm">
                <thead className="cell-density bg-muted/50"><tr>
                  ...
                  <th className="cell-density text-left w-24">Qty</th>
                ...
                <tbody className="divide-y divide-border">
                  ...
                  {form.line_items.length === 0 && <tr><td colSpan={5} className="cell-density text-center text-muted-foreground text-sm">Load from invoice or add rows manually</td></tr>}
                </tbody>
              </table>
            </div>
          ...
          {viewDetail && (
            <div className="space-y-4">
              ...
              <table className="table-fluid-grid text-sm border rounded-lg overflow-hidden">
                <thead className="cell-density bg-muted/50"><tr>
                  <th className="cell-density text-left">Item</th><th className="cell-density text-right">Qty</th>
                  <th className="cell-density text-right">Price</th><th className="cell-density text-right">Total</th>
                </tr></thead>
                <tbody className="divide-y divide-border">
