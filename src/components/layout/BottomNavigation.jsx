...
export default function BottomNavigation({ onOpenMenu, onOpenFab }) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-card border-t border-border flex justify-around items-center h-16 px-2 pb-safe z-40 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] print:hidden">
