...
export default function Topbar({ pageTitle, onMenuClick }) {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-card border-b border-border flex items-center justify-between px-4 md:px-6 shrink-0 transition-colors duration-200 print:hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="ghost" size="icon" onClick={toggleTheme} className="relative">
          {(resolvedTheme || theme) === 'dark' ? <Moon className="w-4 h-4" /> : <Sun className="w-4 h-4" />}
        </Button>
