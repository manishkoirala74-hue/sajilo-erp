-- 087_add_account_metadata.sql
-- Phase 2 Structural Fix to introduce data-driven reporting metadata

-- 1. Schema Update
ALTER TABLE "ChartOfAccount" ADD COLUMN IF NOT EXISTS "financial_statement" TEXT;
...
-- 3. Refactor RPCs to be data-driven
...
BEGIN
  ...
  SELECT 
    ...
    -- Opening Balances
    CASE WHEN LOWER(COALESCE(a.normal_balance, '')) = 'debit' THEN
