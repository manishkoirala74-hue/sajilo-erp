-- =========================================================================================
-- HOTFIX v15: RESTORE DETAIL GENERAL LEDGER STATEMENT RPC
-- =========================================================================================
-- This script safely updates the Detail General Ledger Statement RPC to use
-- strictly typed UUID joins, preventing the "operator does not exist: uuid = text" silent failure.
