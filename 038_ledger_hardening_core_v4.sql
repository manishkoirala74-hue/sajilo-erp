-- =========================================================================================
-- 038_ledger_hardening_core_v4.sql - AGGRESSIVE RLS HANDLING (FIXED RELATION PARSING)
-- =========================================================================================
...
CREATE POLICY "select_CompanyCommunicationSetting" ON "CompanyCommunicationSetting"  FOR SELECT 
...
CREATE POLICY "insert_CompanyCommunicationSetting" ON "CompanyCommunicationSetting"  FOR INSERT 
...
CREATE POLICY "update_CompanyCommunicationSetting" ON "CompanyCommunicationSetting"  FOR UPDATE 
USING ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid()))) 
WITH CHECK ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid())));
CREATE POLICY "delete_CompanyCommunicationSetting" ON "CompanyCommunicationSetting"  FOR DELETE 
USING ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid())));
CREATE POLICY "select_CommunicationOutbox" ON "CommunicationOutbox"  FOR SELECT 
USING ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid())));
CREATE POLICY "insert_CommunicationOutbox" ON "CommunicationOutbox"  FOR INSERT 
WITH CHECK ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid())));
CREATE POLICY "update_CommunicationOutbox" ON "CommunicationOutbox"  FOR UPDATE 
USING ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid()))) 
WITH CHECK ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid())));
CREATE POLICY "delete_CommunicationOutbox" ON "CommunicationOutbox"  FOR DELETE 
USING ((EXISTS (SELECT 1 FROM "User" WHERE id = auth.uid() AND role = 'admin')) OR (company_id IN (SELECT company_id FROM "UserCompany" WHERE user_id = auth.uid())));
