-- 071_comprehensive_inventory_fix_v3.sql
...
-- Create a temporary table to hold the aggregated stock calculations
CREATE TEMP TABLE temp_aggregated_stock AS
SELECT 
    company_id,
    godown_id,
    item_id,
...
FROM temp_aggregated_stock agg
...
DROP TABLE temp_aggregated_stock;
