-- =========================================================================================
-- HOTFIX v11: RESTORE CORRECT POSTING ENGINE FUNCTIONS
-- =========================================================================================
...
-- 1. Internal Journal Entry Function (Fixes "narration" and "reference_number" schema mismatch)
...
BEGIN
    ...
    -- Corrected Schema Columns: description, voucher_no, total_debit, total_credit
    ...
    LOOP
        INSERT INTO "GeneralLedgerLine" (
            journal_id, account_id, debit_amount, credit_amount, description, entity_id
        ) VALUES (
            v_journal_id, 
...
-- 2. Financial Voucher Posting (Safely maps 'narration' to 'description')
...
-- 3. Sales Invoice Posting (Handles non-existent gl_journal_id property in SalesInvoice table)
...
-- 4. Purchase Invoice Posting (Handles non-existent gl_journal_id property in PurchaseInvoice table)
