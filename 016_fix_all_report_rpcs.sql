-- FIX REPORT RPCs TYPE CASTING
-- GeneralLedgerLine 'journal_id' and 'account_id' are stored as TEXT in the DB.
-- We MUST cast UUIDs (j.id, c.id, b.id) to TEXT when joining them.
