-- =========================================================================================
-- 038_ledger_hardening_core_fixed.sql - COMPLETE UPGRADE WITH RLS HANDLING
-- =========================================================================================

BEGIN;

-- 1. DROP ALL DEPENDENT RLS POLICIES TEMPORARILY
...
-- 3. RECREATE RLS POLICIES (NATIVE UUIDs, NO CASTING)
